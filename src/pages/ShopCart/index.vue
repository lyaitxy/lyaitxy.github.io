  ...
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart) in carInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" minnum="1" class="itxt" :value="cart.skuNum" @click="handle('change', event.target,value * 1, cart)">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" @change="updateAllCheckedCart" :checked="isAllChecked && carInfoList.length > 0" >
        <span>全选</span>
      </div>
      <div class="option">
